...
fn test_json_deserialize() {
    ...
    assert_eq!(parsed_tx.unsigned_tx.network_id, 1_000_000);
    assert_eq!(
...
impl StakeableLockOut {
    ...
    /// # Panics
    ///
    /// 如果类型名称未在 `codec::P_TYPES` 中注册，则会 panic。
    #[must_use]
    pub fn type_id() -> u32 {
        u32::try_from(*(codec::P_TYPES.get(&Self::type_name()).unwrap()))
